...
const BUILTINS: &[&str] = &[".", ":", "[", "alias", "bg", "builtin", "cd", "command", "echo", "exec", "exit", "export", "false", "fg", "history", "jobs", "printf", "pwd", "read", "return", "source", "test", "true", "type", "unalias", "unset", "wait"];
