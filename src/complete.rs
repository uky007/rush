...
const BUILTINS: &[&str] = &[".", ":", "[", "alias", "bg", "builtin", "cd", "command", "dirs", "echo", "eval", "exec", "exit", "export", "false", "fg", "history", "jobs", "popd", "printf", "pushd", "pwd", "read", "return", "set", "source", "test", "trap", "true", "type", "unalias", "unset", "wait"];
