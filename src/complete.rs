...
const BUILTINS: &[&str] = &[".", ":", "[", "alias", "bg", "builtin", "cd", "command", "declare", "dirs", "echo", "eval", "exec", "exit", "export", "false", "fg", "history", "jobs", "popd", "printf", "pushd", "pwd", "read", "return", "set", "source", "test", "trap", "true", "type", "unalias", "unset", "wait"];
