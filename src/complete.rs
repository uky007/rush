...
const BUILTINS: &[&str] = &[".", ":", "[", "alias", "bg", "builtin", "cd", "command", "dirs", "echo", "exec", "exit", "export", "false", "fg", "history", "jobs", "popd", "printf", "pushd", "pwd", "read", "return", "source", "test", "true", "type", "unalias", "unset", "wait"];
